...
class Shiyexiangpi(Base):
    """定位所需要用到的元素"""
    ele_name = ('xpath','//*[@id="page-index"]/div[3]/div[2]/div[1]/div[1]/div/input')  # 姓名输入框
    ele_birthday = ('xpath', '//*[@id="page-index"]/div[3]/div[2]/div[1]/div[3]/div')  # 出生日期输入框
    ele_ljcs = ('xpath','//*[@id="page-index"]/div[3]/div[2]/div[2]/div/img')  # 立即测算按钮
    ele_tips = ('xpath','/html/body/div[6]/div/span/div/div/div/div')  # 提示框
    ele_wc = ('xpath','/html/body/div[3]/div[3]/div[1]/div[2]')  # 完成按钮
    ele_qrzq = ('xpath','/html/body/div[3]/div[2]/div[3]/div[2]/span')  # 确认正确按钮
    ele_wxzf = ('xpath','//*[@id="pay"]/div[2]/div[2]/div[2]/div[2]/ul/li[1]/div[2]/div')  # 微信支付
    ele_zfbzf = ('xpath','//*[@id="pay"]/div[2]/div[2]/div[2]/div[2]/ul/li[2]/div[2]/div')  # 支付宝支付
    ...
    ele_lsdd = ('xpath','//*[@id="page-index"]/div[3]/div[3]/div')  # 历史订单
