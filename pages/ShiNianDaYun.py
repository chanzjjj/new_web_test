...
class Shiniandayun(Base):
    """定位所需要用到的元素"""
    ele_name = ('xpath','//*[@id="root"]/div[3]/div[2]/div/div[1]/div/div[1]/div/input')     #姓名输入框
    ...
    ele_birthday = ('xpath', '//*[@id="root"]/div[3]/div[2]/div/div[1]/div/div[3]/div')  # 出生日期选择框
    ele_ljcs = ('xpath', '//*[@id="root"]/div[3]/div[2]/div/div[2]/div/img')  # 立即测算按钮
    ...
    ele_lsdd = ('xpath', '//*[@id="root"]/div[3]/div[3]/div')  # 查询历史订单按钮
