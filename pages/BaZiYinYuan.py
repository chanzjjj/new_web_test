...
class Baziyinyuan(Base):
    '''定义所需要的元素'''
    ele_name = ('xpath','//*[@id="root"]/div[3]/div[2]/div[1]/div[1]/div/input')  # 姓名输入框
    ele_birthday = ('xpath','//*[@id="root"]/div[3]/div[2]/div[1]/div[3]/div')  # 出生日期输入框
    ...
    ele_wxzf = ('xpath','//*[@id="pay"]/div[3]/div[2]/div[2]/ul/li[2]/div[2]/div')  # 微信支付
    ele_zfbzf = ('xpath','//*[@id="pay"]/div[3]/div[2]/div[2]/ul/li[1]/div[2]/div')  # 支付宝支付
    ele_ylzf = ('xpath','//*[@id="pay"]/div[3]/div/div[2]/ul/li[3]/div[2]/div')  # 银联支付
    ele_ppzf = ('xpath','//*[@id="pay"]/div[3]/div/div[2]/ul/li[4]/div[2]/div')  # paypal支付
    ele_gdzf = ('xpath','//*[@id="pay"]/div[3]/div/div[2]/div')  # 更多支付按钮
    ele_lsdd = ('xpath','//*[@id="root"]/div[3]/div[2]/p/a')  # 历史订单
