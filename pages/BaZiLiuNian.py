...
class Baziliunian(Base):
    '''定义所需要的元素'''
    ele_sy_ljcs = ("xpath",'//*[@id="root"]/div/div[3]/div[3]/div[1]/img')
    ele_name = ("xpath",'//*[@id="root"]/div/div[1]/div[1]/div/div/div[1]/div/input')  # 姓名输入框
    ele_birthday = ("xpath", '//*[@id="root"]/div/div[1]/div[1]/div/div/div[3]/div')  # 出生日期输入框
    ele_ljcs = ("xpath",'//*[@id="root"]/div/div[1]/div[2]/div')# 立即测算按钮
    ...
    ele_wxzf = ("xpath",'//*[@id="wx"]')  # 微信支付
    ele_zfbzf = ("xpath",'//*[@id="ali"]')  # 支付宝支付
    ...
    ele_lsdd = ("xpath",'//*[@id="root"]/div/div[3]/div[3]/p/a')  # 历史订单
