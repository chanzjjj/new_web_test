...
class Gerenzhanxing(Base):
    ...
    ele_name = ("xpath", '//*[@id="root"]/div/div[3]/div[1]/ul/li[1]/div/input') #姓名
    ...
    ele_birthday = ("xpath",'//*[@id="root"]/div/div[3]/div[1]/ul/li[3]/div/div/span')  #出生日期选择框
    ele_space = ("xpath",'//*[@id="root"]/div/div[3]/div[1]/ul/li[4]/div/div/span')  #出生地点选择框
    ele_ljcs = ("xpath",'//*[@id="root"]/div/div[3]/div[1]/div/div/div/img')  #立即测算按钮
    ...
    ele_gengduo = ("xpath",'//*[@id="pay"]/div[3]/div/div[2]/div[2]/div')  #更多支付方式按钮
    ele_lsdd = ("xpath",'//*[@id="root"]/div/div[3]/div[3]/div')  #历史订单
