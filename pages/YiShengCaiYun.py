...
class Yishengcaiyun(Base):
    '''定义所需要的元素'''
    ele_name = ('xpath','//input[@type="text"]')     #姓名输入框
    ele_boy = ('xpath', '//label[@for="id_male_1"]')  # 性别为男
    ele_girl = ('xpath', '//label[@for="id_female_1"]')  # 性别为女
    ele_birthday = ('xpath', '//div[@class="zxcs-picker zxcs-input-control"]')  # 出生日期选择框
    ele_ljcs = ('xpath', '//div[@class="order-btn"]')  # 立即测算按钮
    ele_tips = ('xpath', "/html/body/div[5]/div/span/div/div/div/div")  # 姓名为空时的提示
    ele_wc = ('xpath', '//div[@class="picker-confirm"]')  # 完成按钮
    ele_qrzq = ('xpath', "/html/body/div[3]/div[2]/div/div[2]/div[2]/div/button[2]")  # 确认正确按钮
    ele_gdzf = ('xpath','//div[@class="more-pay"]')         #更多方式按钮
    ele_wxzf = ('xpath', "//*[@id='pay2']/div[3]/div/div[2]/div[2]/ul/li[2]/div[2]/div")  # 微信支付按钮
    ele_zfbzf = ('xpath', "//*[@id='pay2']/div[3]/div/div[2]/div[2]/ul/li[1]/div[2]/div")  # 支付宝支付按钮
    ele_ylzf = ('xpath', "//*[@id='pay2']/div[3]/div/div[2]/div[2]/ul/li[3]/div[2]/div")  # 银联支付方式
    ele_ppzf = ('xpath', "//*[@id='pay2']/div[3]/div/div[2]/div[2]/ul/li[4]/div[2]/div")  # paypal支付按钮
    ele_lsdd = ('xpath', '//*[@id="root"]/div/div[3]/div[2]/div/p/a')  # 查询历史订单按钮
    ele_ddh = ('xpath', "//*[@id='orderList']/li/div[3]/div[2]")  # 订单号
    #ele_guanbi = ('xpath', '//img[@alt="close"]')  # 返回弹窗的关闭按钮
